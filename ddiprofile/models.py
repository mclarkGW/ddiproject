...
#GAP Dashboard Models
class gapEpic(models.Model):
    id = models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
    workitemtype = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
...
class gapChangeRequest(models.Model):
    id = models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
    workitemtype = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
    ...
    tt_onshorewbs = models.CharField(max_length=255, blank=True, null=True)
    tt_offshorewbs = models.CharField(max_length=255, blank=True, null=True)
    epicparent = models.ForeignKey(gapEpic, on_delete=models.CASCADE, blank=True, null=True)
    epicnumber = models.CharField(max_length=255, blank=True, null=True)

class gapFeature(models.Model):
    id = models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
    workitemtype = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
    ...
    tt_onshorewbs = models.CharField(max_length=255, blank=True, null=True)
    tt_offshorewbs = models.CharField(max_length=255, blank=True, null=True)
    cr_related = models.ForeignKey(gapChangeRequest, on_delete=models.CASCADE, related_name='features')

class gapUserStory(models.Model):
    id = models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
    workitemtype = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
    ...
    tt_onshorewbs = models.CharField(max_length=255, blank=True, null=True)
    tt_offshorewbs = models.CharField(max_length=255, blank=True, null=True)
    feature_related = models.ForeignKey(gapFeature, on_delete=models.CASCADE,related_name='user_stories')

class gapTask(models.Model):
    id= models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
    workitemtype = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
    ...
    remainingwork = models.CharField(max_length=255, blank=True, null=True)
    completedwork = models.CharField(max_length=255, blank=True, null=True)
    userstory_related = models.ForeignKey(gapUserStory, on_delete=models.CASCADE, related_name='tasks')

class gapLastRefreshed(models.Model):
    id = models.IntegerField(primary_key=True)
    title = models.CharField(max_length=255)
